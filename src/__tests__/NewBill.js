...
describe("Given I am connected as an employee", () => {
  describe("When I am on NewBill Page", () => {
    ...
    test("Then when i import a file it should run the handleChangeFile function and call store", async () => {
      const html = NewBillUI()
      document.body.innerHTML = html
      const onNavigate = (pathname) => {
        document.body.innerHTML = ROUTES({ pathname })
      }
      const billsMethod = jest.spyOn(mockStore, 'bills')
      const mockBill = new NewBill({ document, onNavigate, store: mockStore, localStorage })
      const e = {
        preventDefault: () => { },
    ...
    test("Then when i import a file it should run the handleChangeFile function and log error", async () => {
      const html = NewBillUI()
      document.body.innerHTML = html
      const onNavigate = (pathname) => {
        document.body.innerHTML = ROUTES({ pathname })
